...
class FaceAugDataGen( object ):
    idx = 0
    def __init__ (self, mode = 'training', batch_size = 16, im_shape = (224,224), source = None, mean_file=None  , latent_dim = 2048, if_xscale = False):
    ...
    def __getitem__(self, batch_idx):
        ...
        #return X,Y
        return X, [X, np.zeros((self.batch_size, 1,1,1))]
        '''
