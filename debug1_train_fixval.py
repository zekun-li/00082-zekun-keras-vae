...
is_sum = True
b_size = 32
saved_weights = 'weights/debug_01_lr0.0001_latentdim2048_nomeanfile_sumloss-best-10-2241.75.hdf5'
lr_rate = 0.0001  
...
def train():
    ...
    H = model.fit_generator(generator = train_datagen, steps_per_epoch = train_steps_per_epoch, epochs = 10, validation_data = (valid_X, [valid_X1_1,valid_X1_2]), callbacks =mycallbacks )
