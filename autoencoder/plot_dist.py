...
predict_x = encoder.predict(valid_x, batch_size = 16)
#np.save( '000_valid_X.npy',valid_X)
np.save( '000_predict_X.npy',predict_x)
#np.save( '000_valid_Y.npy',valid_Y)
