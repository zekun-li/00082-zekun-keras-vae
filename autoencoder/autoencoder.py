...
def Autoencoder(original_dim = (224,224,3), latent_dim = 2048, epsilon_std = 1.0, lr = 0.0001, is_sum = True): 
    ...
    x = Conv2D(512, (3, 3), activation='relu', padding='same', name='block5_conv3',strides = 2)(x)
    ...
    model = Model(img, [decode_conv2_5])     
    ...
    model.compile(optimizer=rmsprop,loss=[l2_loss])                                   
