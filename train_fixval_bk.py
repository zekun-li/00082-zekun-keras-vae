...
prefix = '01_lr'+ str(lr_rate) + '_latentdim' + str(latent_dim)
...
if mean_img_file is not None:
    ...
    train_datagen = FaceAugDataGen(mode = 'training', batch_size=b_size ,im_shape = (224,224), source = data_path)
    val_datagen = FaceAugDataGen(mode = 'validation', batch_size=b_size ,im_shape = (224,224), source = data_path)
